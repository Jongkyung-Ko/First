...
from chart_snapshot import build_and_save_region_snapshot  # noqa: E402
from main import CHART_MARKET_UNIVERSES, _fetch_price_change, collect_chart_data  # noqa: E402

OUTPUT = os.path.join(ROOT, "data", "chart-us-snapshot.json")
...
def main() -> None:
    ...
    print(f"Building US chart snapshot (trigger={trigger})...")
