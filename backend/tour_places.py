...
UNIQUE_PLACES: list[dict[str, str]] = [
    ...
    {"slug": "svalbard-no", "continent": "Europe", "continent_ko": "유럽", "country": "Norway", "country_ko": "노르웨이", "city": "Svalbard", "city_ko": "스발바르", "search_query": "Svalbard arctic landscape travel"},
